...
const LinkButton = React.forwardRef<HTMLButtonElement, ButtonProps>((props, ref) => (
  <Button variant="link" ref={ref} {...props} />
))
LinkButton.displayName = "LinkButton"

export { Button, DestructiveButton, OutlineButton, SecondaryButton, GhostButton, LinkButton }
